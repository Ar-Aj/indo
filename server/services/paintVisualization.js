...
class PaintVisualizationService {
  ...
  async generatePlainPaintedWall(originalImagePath, maskImagePath, colorHex, colorName) {
    ...
    const plainPayload = {
      ...
      prompt: `paint this wall  ${colorName} color ${colorHex}, solid paint color  coverage of ${colorHex}, change wall color completely to  ${colorName} ${colorHex}, professional interior design, no changes to room, furniture, objects, people`,
